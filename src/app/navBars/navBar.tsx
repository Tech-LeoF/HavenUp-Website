      ...
      <div className="flex space-x-6 text-white items-center" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        {isSeller && (
          <>
            ...
            <Link href="/publish">
              <button className="text-[#073B3A] bg-[#F5F5DC] w-[clamp(3rem,8vw,15rem)] h-[clamp(2rem,6vh,3rem)] text-[clamp(0.7rem,1.2vw,1rem)] rounded-lg cursor-pointer hover:drop-shadow-[0_0_4px_gray] transition duration-400">
                Publish a house
              </button>
            </Link>
          </>
        ...
        {isBuyer && (
          <>
            <Link href="/buy">
              <button className="text-[#073B3A] bg-[#F5F5DC] w-[clamp(3rem,10vw,18rem)] h-[clamp(2rem,6vh,3rem)] text-[clamp(0.7rem,1.2vw,1rem)] rounded-lg cursor-pointer hover:drop-shadow-[0_0_4px_gray] transition duration-400">
                Buy houses
              </button>
            </Link>
          </>
