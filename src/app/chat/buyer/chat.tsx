    ...
    <aside className="w-1/4 bg-white p-6 border-r border-gray-300 flex flex-col items-center text-center">
      ...
      {/* Chat Area */}
        ...
        <form onSubmit={handleSend} className="mt-auto pt-4 border-t border-gray-300 flex items-center space-x-2">
            ...
            <input type="text" placeholder="Type your message here..." className="flex-grow text-[#073B3A] p-3 text-lg rounded-2xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#629584] placeholder-white-400 " value={input} onChange={e=>setInput(e.target.value)} />
