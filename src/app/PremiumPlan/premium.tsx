...
const PricingPlans = () => {
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="bg-[var(--background)] text-[var(--foreground)] min-h-screen py-12 px-4 sm:px-6 lg:px-20">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="h-100 w-90 rounded-xl p-6 bg-white shadow-xl  border-transparent border-3 hover:border-[#629584] transform hover:scale-105 transition-all duration-300  flex flex-col justify-between">
            <div>
          ...
          <div className=" w-90 h-full rounded-xl p-6 bg-white shadow-xl  border-transparent border-3 hover:border-[#629584] transform hover:scale-105 transition-all duration-300 flex flex-col justify-between">
            <div>
