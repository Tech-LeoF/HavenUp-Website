    ...
    return (
        <div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-6 border-r border-black">
                <img src="/Imgs/casa.png" alt="casa" className="w-[clamp(5rem,10vw,12rem)] h-auto mb-4"/>
                <h2 className="text-white text-[clamp(1.5rem,3vw,2rem)] font-semibold mb-2">3D visualization</h2>
                <p className="text-white text-[clamp(0.5rem,3vw,1.5rem)] leading-relaxed">
                    See your dream home in 3D and explore it from every angle.
                </p>
            </div>
            <div className="flex-1 flex flex-col items-center justify-center text-center p-6 border-r border-black">
                <img src="/Imgs/ubication.png" alt="ubication" className="w-[clamp(3rem,10vw,7rem)] h-auto mb-4"/>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
                <img src="/Imgs/carretera.png" alt="carretera" className="w-[clamp(3rem,10vw,7rem)] h-auto mb-4"/>
